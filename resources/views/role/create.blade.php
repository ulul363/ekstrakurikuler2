            ...
            <div class="row align-items-center">
                <div class="col-md-12">
                    <div class="page-header-title">
                        <h5 class="m-b-10">Tambah Peran dan Izin</h5>
                    </div>
                    <ul class="breadcrumb">
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-12" style="margin-top: 10px;">
                            <div class="form-group">
                                ...
                                <input type="text" name="name" id="name" class="form-control"
                                    placeholder="Nama Role" autofocus autocomplete="off" style="margin-top: 10px;">
                            </div>
                            <div class="form-group">
                                <strong>Guard Name:</strong>
                                <br>
                                <input type="text" name="guard_name" id="guard_name" class="form-control"
                                    value="web" readonly style="margin-top: 10px;">
                            </div>
